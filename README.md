...
* [GHCQ Gaffer](https://github.com/GovernmentCommunicationsHeadquarters/Gaffer) - Gaffer by GHCQ is a framework that makes it easy to store large-scale graphs in which the nodes and edges have statistics
